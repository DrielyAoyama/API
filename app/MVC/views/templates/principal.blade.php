...
<head>
	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="{{PASTA_PUBLIC}}/arquivos/assets/img/apple-icon.png">
	<link rel="apple-touch-icon" sizes="76x76" href="{{PASTA_PUBLIC}}/arquivos/assets/img/apple-icon.png">
	<link rel="icon" type="image/png" sizes="96x96" href="{{PASTA_PUBLIC}}/arquivos/assets/img/favicon.png">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />

	<title>ServiceAPI - @yield('titulo')</title>
    ...
    <link  href="{{PASTA_PUBLIC}}/arquivos/assets/css/animate.min.css" rel="stylesheet" />


    <!--  Paper Dashboard core CSS    -->
    <link  href="{{PASTA_PUBLIC}}/arquivos/assets/css/paper-dashboard.css" rel="stylesheet" />


    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link  href="{{PASTA_PUBLIC}}/arquivos/assets/css/demo.css" rel="stylesheet" />
...
<div class="wrapper">
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand">@yield('titulo')</a>
                </div>
               <ul class="nav navbar-nav navbar-right">
                        
                        <li>
                            <a href="{{asset('usuarios/sair')}}">
                                <i class="ti-close"></i>
                                <p>Sair</p>
                            </a>
                        </li>
	...
	<script src="{{PASTA_PUBLIC}}/arquivos/assets/js/bootstrap-checkbox-radio.js"></script>

	<!--  Charts Plugin -->
	<script src="{{PASTA_PUBLIC}}/arquivos/assets/js/chartist.min.js"></script>

    <!--  Notifications Plugin    -->
    <script src="{{PASTA_PUBLIC}}/arquivos/assets/js/bootstrap-notify.js"></script>

    <!--  Google Maps Plugin    -->
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js"></script>

    <!-- Paper Dashboard Core javascript and methods for Demo purpose -->
	<script src="{{PASTA_PUBLIC}}/arquivos/assets/js/paper-dashboard.js"></script>
